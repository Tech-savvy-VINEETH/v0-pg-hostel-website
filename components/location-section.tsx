    ...
    <section className="bg-secondary/30 py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          {/* Embedded Google Map */}
          <div className="relative aspect-[4/3] overflow-hidden rounded-xl bg-muted lg:aspect-auto lg:h-full lg:min-h-[400px]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.0123456789!2d77.5946!3d12.9716!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTLCsDU4JzE3LjgiTiA3N8KwMzUnNDAuNiJF!5e0!3m2!1sen!2sin!4v1234567890"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
            ...
            />
            <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between rounded-lg bg-background/95 p-3 shadow-lg backdrop-blur-sm">
              <div>
                <h3 className="font-serif font-bold">HomeStay PG</h3>
                <p className="text-sm text-muted-foreground">123 Green Avenue, City Center</p>
              </div>
              <a
